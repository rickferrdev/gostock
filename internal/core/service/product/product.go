...
func (service *Service) Create(ctx context.Context, product *domain.Product) (*domain.Product, error) {
	...
	// ID should be empty when creating a new product, as it will be generated by the service.
	if product.ID != "" {
...
func (service *Service) Update(ctx context.Context, product *domain.Product) error {
	...
	old, err := service.product.ByID(ctx, product.ID)
	if err != nil {
	...
	if old.StockID == product.StockID {
		realAvailableSpace := stock.AvailableSpace() + old.Qtd
...
func (service *Service) Delete(ctx context.Context, id string) error {
	...
	if err := service.product.DeleteAtomic(ctx, id); err != nil {
		return service.Errors(err)
	}
